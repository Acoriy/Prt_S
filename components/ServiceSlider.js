...
const serviceData = [
  {
    ...
    title: "Development",
    description:
      "I transform your ideas into seamless,engaging user experiences.",
  },
  {
    icon: <RxPencil2 />,
    title: "Design",
  ...
  },
  {
    ...
    description:
      "Results-driven digital marketing to grow your traffic, leads, and sales.",
  },
  // {
  //   icon: <RxRocket />,
  //   title: 'SEO',
      ...
      {serviceData.map((item, index) => {
        return (
          <SwiperSlide key={index}>
            ...
            >
              <div
                className="bg-[rgba(65,47,123,0.15)] h-max rounded-lg px-6 py-8 xl:min-h-[300px]
