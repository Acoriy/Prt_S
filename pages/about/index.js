...
const aboutData = [
  ...
  },
  {
    ...
    info: [
      ...
      {
        title:
          "DTS Devloppment Informatique - Higher Institute of Applied Technology Technician specialized in computer development",
        stage: "Août 2020 - Juillet 2022",
      },
      {
        title:
          "A Year At Ibn Zohr University Agadir - Chemistry science branch First year.",
        stage: "Août 2019 - Avril 2020",
      },
      {
        title:
          "Baccalaureate - I had my baccalaureate in the Abdellah Chefchaouni high school.Physics and chemistry branch.",
  ...
  },
  {
    ...
    info: [
      {
        title:
          "FREELANCE –  Full-Stack Web Developer & UI/UX Designer & Digital Marketer(SEO, Meta Ads)",
        stage: "2024 - Currently",
      },
      {
        title: "FREELANCE Full Stack Web Developer - NanoSoft LY ",
        stage: "March 2025 - June 2025",
      },
      {
        title: "FREELANCE Frontend Web Developer - Noblessa Cuisines ",
        stage: "February 2024 - March 2024",
      },
      {
        title: "RGPH 2024 Surveyor - High Commission for Planning of Morocco",
        stage: "August 2024 – September 2024",
      },
      {
        title: "Email Agent Full-time - ADSENTYA SARL in Ouled Teima",
      ...
      {
        title:
          'developing the desktop application for excavation management propection  - RMA - Royale Marocaine d"Assurance',
  ...
  },
  {
    ...
    info: [
      ...
      {
        title:
          "Attestation Participation RGPH 2024 - Haut Commissariat au Plan du Maroc",
        stage: "2024",
        link: "https://drive.google.com/file/d/1clh7o2599EKX8-R_GhmG0MGcP8O71NJX/view?usp=sharing",
      },
      {
        title:
          "Attestation Formation Adistances RGPH 2024 - Haut Commissariat au Plan du Maroc",
        stage: "2024",
  ...
  return (
    <div className="h-full bg-primary/30 py-32 text-center xl:text-left">
      ...
      <div className="container mx-auto  ">
        <div
          className="h-full flex flex-col items-center  justify-center my-auto
        xl:flex-row gap-x-6 "
        >
          {/* text */}
                    ...
                    <div className="flex gap-x-4">
                      ...
                      {item.icons?.map((icon, itemIndexText2) => {
                        return (
                          <div
                            key={itemIndexText2}
                            className="text-2xl hover:text-3xl text-white hover:-translate-y-3 hover:border hover:border-x-accent hover:border-y-accent hover:border-x-2 hover:border-y-2 hover:p-1 hover:shadow-md hover:shadow-secondary rounded-md transition-transform duration-300 ease-in-out"
                          >
                            {icon}
                          </div>
                        );
